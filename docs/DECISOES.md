...
- Números medidos: fila de 5.000 itens entre 4,95ms e 5,81ms nas execuções do probe, contra o teto de 200ms da RNF-03. O `better-sqlite3@13.0.3` fez 0,19ms no mesmo cenário — diferença irrelevante contra o orçamento.
